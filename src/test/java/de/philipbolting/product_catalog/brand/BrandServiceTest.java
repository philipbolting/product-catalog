...
class BrandServiceTest {
    ...
    void createBrand_withDuplicateSlug_shouldThrowException() {
        ...
        var exception = assertThrows(IllegalArgumentException.class, () -> brandService.createBrand(dto));
        assertEquals("Brand with slug " + dto.slug() + " already exists", exception.getMessage());
    }
    ...
    void createBrand_withDuplicateName_shouldThrowException() {
        ...
        var exception = assertThrows(IllegalArgumentException.class, () -> brandService.createBrand(dto));
        assertEquals("Brand with name " + dto.name() + " already exists", exception.getMessage());
    }
